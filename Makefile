...
.PHONY: clean clean-testdata clean-kitodo-testdata prepare prepare-keys prepare-examples build build-kitodo start down config status test test-kitodo help
